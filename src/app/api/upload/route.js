...
export async function GET() {
  try {
    ...
    // If no core files exist, return a 404 (optional, based on your app's minimum requirement)
    // For this case, we'll assume a 200 is fine even if only batch files exist,
    // but if you *must* have core files, you'd add a check here.
    // Example: if (!coreFiles.some((_, index) => existenceChecks[index])) { ... }
